...
Shift the unit of analysis to _areas_: which neighborhoods/zipcodes look similar based on the mix of business types present? Build this as an interactive Streamlit app.
